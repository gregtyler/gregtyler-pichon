...
Last year, for the first time in many years, I wrote some [resolutions for myself][resolutions]. Let's see how I got on.
...
[SSL 10054](/ssl-read-errno-10054/) is still my most popular article by far. And user retention has gone up since switching from WordPress to custom Node.js, even though features like "recommended articles" and search are now missing.
